                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div class="flex justify-between items-center pt-3">
                                            <div class="flex items-center">
                                                ...
                                                />
                                                <label for="remember" class="pl-2 font-light text-gray-900 text-sm">
                                                    Souviens-toi de moi
                                                </label>
                                            </div>
                                        ...
                                        <div class="pt-6">
                                            <button type="submit"
                                                class="py-4 w-full text-white bg-orange-500 rounded-lg hover:bg-orange-600 focus:ring-4 focus:ring-red-100 focus:outline-none h-12 flex items-center justify-center uppercase font-medium"
                                            >

...
function SearchInput(props) {
    ...
    return (
        <div class="mx-auto w-full lg:w-4/5">
            <div class="flex items-center w-full shadow bg-white px-2 h-12 md:h-12 gap-x-1 rounded mt-4">
                ...
                <button onClick={() => handleSearch()}
                    class="hidden md:block bg-principal rounded text-[14px] px-3 py-2 text-white hover:bg-green-500 shadow-md"
                >
                    Rechercher
                </button>
            </div>
